    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            <div class="d-flex justify-content-end align-end align-items-end mb-2">
                <button class="btn btn-sm btn-primary" onclick="location.href='<?= base_url() ?>/admin/transaksi_action/buat'"><i class="fas fa-plus-circle"></i> Tambah Data</button>
            </div>
                        ...
                        <?php foreach (get() as $row) { ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!-- Modal -->
                                    <div class="modal fade" id="hapusData<?= $row->id_transaksi ?>" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    Yakin hapus data, <?= $row->kode_invoice ?>?
                                                </div>
