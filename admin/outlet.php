    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            <div class="d-flex justify-content-end align-end align-items-end mb-2">
                <button class="btn btn-sm btn-primary" onclick="location.href='<?= base_url() ?>/admin/outlet_action/buat'"><i class="fas fa-plus-circle"></i> Tambah Data</button>
            </div>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    ?>
                                                    <button type="button" class="btn btn-primary" onclick="location.href='<?= base_url() . '/admin/outlet_action/hapus?id=' . $row->id . '&token=' . $_SESSION['token'] ?>'"><i class="fas fa-check"></i> Ya, hapus</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
