...
<div class="container-fluid mb-2">
    ...
    ?>
            ...
            <div class="form-group row">
                    <div class="col">
                        <input type="text" name="nama_paket" class="form-control" placeholder="Masukkan nama paket..." value="<?= $data->nama_paket ?>">
                    </div>
                    <div class="col">
                ...
                <div class="form-group row">
                    <div class="col">
                        <input type="text" name="jenis" class="form-control" placeholder="Jenis paket..." value="<?= $data->jenis ?>">
                    </div>
                    <div class="col">
                        <input type="number" name="harga" class="form-control" placeholder="Harga paket..." value="<?= $data->harga ?>">
                    </div>
                </div>
